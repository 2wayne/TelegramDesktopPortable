...
user in an INI file next to TelegramDesktopPortable.exe called TelegramDesktopPortable.ini.
...
copy AppNamePortable.ini from this directory to TelegramDesktopPortable.ini next to
TelegramDesktopPortable.exe. The options in the INI file are as follows:
